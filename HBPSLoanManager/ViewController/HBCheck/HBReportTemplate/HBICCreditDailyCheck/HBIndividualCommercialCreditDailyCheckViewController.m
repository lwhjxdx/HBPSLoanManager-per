//
//  HBIndividualCommercialCreditDailyCheckViewController.m
//  HBPSLoanManager
//
...
@interface HBIndividualCommercialCreditDailyCheckViewController ()
{
    NSArray *titleArray;
...
@implementation HBIndividualCommercialCreditDailyCheckViewController
...
- (void)viewDidLoad
{
    ...
    [self initWithDate];
    //绘制UI界面
    [self createSuViewByIndividualCommercialCreditDailyCheckView];
    
}

- (void)createSuViewByIndividualCommercialCreditDailyCheckView
{
    //最外层为一层 scrollView
...
//点击下一步事件
- (void)nextStep{
    HBIClCreditDailyCheckNextViewController *vc = [[HBIClCreditDailyCheckNextViewController alloc] init];
