//
//  HBICFirstTrackingNextViewController.m
//  HBPSLoanManager
//
...
@interface HBICFirstTrackingNextViewController ()
{
    NSArray *_titleArray;
    NSArray *_itemArray1;
    NSArray *_itemArray2;
...
@implementation HBICFirstTrackingNextViewController
...
- (void)viewDidLoad
{
    ...
    self.checkType = individualCommercialFirstTracking;
    self.requestUrl = kInsertPersonalIndexModel;
    
    //初始化数据源
    [self initWithDate];
    //绘制UI界面
    [self createSuViewByICFirstTrackingNextView];
}

- (void)createSuViewByICFirstTrackingNextView
{
