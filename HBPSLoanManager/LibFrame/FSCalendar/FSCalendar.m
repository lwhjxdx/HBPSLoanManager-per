...
#define kPink       [UIColor colorWithRed:0.298 green:0.776 blue:0.027 alpha:1.000]
...
- (FSCalendarCellSelectStlye)cellSelectStyleForData:(NSDate *)date;
...
- (void)initialize
{
    ...
    _backgroundColors[@(FSCalendarCellStateToday)]       = [UIColor greenColor];
    ...
    _titleColors[@(FSCalendarCellStateWeekend)]       = kBlue;
    _titleColors[@(FSCalendarCellSelectStlyeDelay)]   = [UIColor whiteColor];
    _titleColors[@(FSCalendarCellSelectStlyeUnfinished)]   = [UIColor whiteColor];
    _titleColors[@(FSCalendarCellSelectStlyeFinished)]   = [UIColor whiteColor];
    ...
    _subtitleColors[@(FSCalendarCellStateWeekend)]       = kBlue;
    _subtitleColors[@(FSCalendarCellSelectStlyeDelay)]   = [UIColor whiteColor];
    _subtitleColors[@(FSCalendarCellSelectStlyeUnfinished)]   = [UIColor whiteColor];
    _subtitleColors[@(FSCalendarCellSelectStlyeFinished)]   = [UIColor whiteColor];
...
//    }
    ...
    cell.cellSelectStyle    = [self cellSelectStyleForData:cell.date];
...
- (FSCalendarCellSelectStlye)cellSelectStyleForData:(NSDate *)date
{
    if (_dataSource && [_dataSource respondsToSelector:@selector(calendar:calendarCellSelectStlye:)]) {
        return [_dataSource calendar:self calendarCellSelectStlye:date];
    }
