...
#endif
typedef NS_OPTIONS(NSInteger, FSCalendarCellSelectStlye) {
    FSCalendarCellSelectStlyeFinished   = 500,
    FSCalendarCellSelectStlyeDelay      = 5001,
    FSCalendarCellSelectStlyeUnfinished = 502
};
