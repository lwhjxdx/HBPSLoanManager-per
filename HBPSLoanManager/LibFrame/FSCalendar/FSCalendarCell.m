...
- (UIColor *)colorForCurrentStateInDictionary:(NSDictionary *)dictionary
{
    ...
    if (self.isSelected) {
        if (self.cellSelectStyle == FSCalendarCellSelectStlyeFinished) {
            return dictionary[@(FSCalendarCellSelectStlyeFinished)];
        }else if (self.cellSelectStyle == FSCalendarCellSelectStlyeUnfinished) {
            return dictionary[@(FSCalendarCellSelectStlyeUnfinished)];
        }else if (self.cellSelectStyle == FSCalendarCellSelectStlyeDelay) {
            return dictionary[@(FSCalendarCellSelectStlyeDelay)];
        }
